...
import com.academiadev.repository.EnrollmentRepository;
...
import com.academiadev.exceptions.CourseNotFoundException;
import com.academiadev.exceptions.EnrollmentException;
...
public class EnrollmentService {
    ...
    // Conta apenas matrículas em cursos ATIVOS
    long currentActiveEnrollments = enrollmentRepository.findByStudent(student).stream()
            .filter(e -> e.getCourse().getStatus() == CourseStatus.ACTIVE)
            .count();
    if (!student.getSubscriptionPlan().canEnroll(currentActiveEnrollments)) {
    ...
    private EnrollmentDTO toDTO(Enrollment enrollment) {
        ...
        dto.setProgress(enrollment.getProgressPercent());
        return dto;
    }
    ...
    private EnrollmentExportDTO toExportDTO(Enrollment e) {
        ...
        dto.setProgress(e.getProgressPercent());
        return dto;
