...
public class MenuView {
    ...
    public int mostrarMenuBoasVindas() {
        System.out.println("\n--- Menu Principal ---");
        System.out.println("1. Consultar catálogo de cursos ativos");
        System.out.println("2. Abrir ticket de suporte");
        System.out.println("3. Login (por email)");
        System.out.println("4. Sair");
        System.out.print("Digite sua opção: ");
        return lerOpcao();
    }

    public String lerEmailParaTicket() {
